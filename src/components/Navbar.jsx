...
//                     { to: "/civil", text: "Civil" },
//                     { to: "/fiber", text: "Fibre" },
//                     { to: "/design-validation", text: "Design Validation" },
//                     { to: "/traffic-management", text: "Traffic Management" },
...
const Navbar = () => {
    ...
    function renderNavLinks(currentPath) {
        ...
        const isServiceSelected = links[2].dropdownLinks.some(dropdownLink => dropdownLink.to === currentPath);
