...
//                     { to: "/civil", text: "Civil" },
//                     { to: "/fiber", text: "Fibre" },
//                     { to: "/design-validation", text: "DV" },
//                     { to: "/traffic-management", text: "TM" },
...
//                             <button
//                                 className={`hover:bg-gray-200 px-3 py-2 text-sm md:text-lg font-medium cursor-pointer flex items-center w-full ${isSelected ? 'bg-gray-200' : ''}`}
//                                 onClick={toggleMenu}
//                             >
...
//                         <Link
//                             to={link.to}
//                             className={`hover:bg-gray-200 px-3 py-2 text-sm md:text-lg font-medium cursor-pointer ${isSelected ? 'bg-gray-200' : ''}`}
//                         >
//                             {link.text}
//                         </Link>
//                     )}
...
// import { motion } from 'framer-motion';
// import { Link, useLocation } from 'react-router-dom';
// import { AiOutlineMenu, AiOutlineClose } from 'react-icons/ai';  // Import the burger icons
// import logo from '../assets/bethmarColor.png';
...
//                                 onClick={toggleMenu}
//                             >
//                                 {link.text} {isOpen ? <AiOutlineClose className="h-4 w-4 ml-auto" /> : <AiOutlineMenu className="h-4 w-4 ml-1" />}
//                             </button>
//                             <div className={`absolute z-10 mt-2 w-32 bg-white rounded-md shadow-lg md:ml-0 ml-[200px] ${isOpen ? '' : 'hidden'}`}>
//                                 {link.dropdownLinks.map((dropdownLink, dropdownIndex) => (
//                                     <Link
...
import { motion } from 'framer-motion';
import { Link, useLocation } from 'react-router-dom';
import { AiOutlineMenu, AiOutlineClose, AiOutlineDown, AiOutlineUp } from 'react-icons/ai'; // Import the icons
import logo from '../assets/bethmarColor.png';
