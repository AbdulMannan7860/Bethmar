            ...
            <div className='bg-gray-100 py-6'>
                ...
                >
                    ...
                    <div className='md:w-8/12 mx-4 md:mx-12'>
                        <h1 className='text-xl md:text-4xl font-semibold md:px-4 py-2 border-b-2 border-accentRed-dark pb-4'>Civil Services</h1>
                ...
                >
                    ...
                    <div className='md:w-8/12 mx-4 md:mx-12'>
                        <h1 className='text-xl md:text-4xl font-semibold md:px-4 py-2 border-b-2 border-accentRed-dark pb-4'>Fibre Services</h1>
